...
def _main():
    annotation_path = 'annotations_test_balance/2_4_bench_door_4000_final.txt'
    log_dir = 'logs/2_4_bench_door_4000/'
    classes_path = 'annotations_test_balance/2_4_bench_door_4000_classes.txt'
