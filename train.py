...
def _main():
    ...
    log_dir = 'logs/4000_adagrad_e2e3_50x2/'
    ...
    if True:
        ...
        model.compile(optimizer=Adagrad(lr=1e-2), loss={
    ...
    if True:
        ...
        model.compile(optimizer=Adagrad(lr=1e-3), loss={'yolo_loss': lambda y_true, y_pred: y_pred}) # recompile to apply the change
