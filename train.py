...
def _main():
    ...
    if True:
        ...
        model.compile(optimizer=Adagrad(lr=1e-1), loss={
    ...
    if True:
        ...
        model.compile(optimizer=Adagrad(lr=1e-2), loss={'yolo_loss': lambda y_true, y_pred: y_pred}) # recompile to apply the change
